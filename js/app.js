  ...
  return '<div style="padding:16px 14px 0;">'
    ...
    + '<div style="display:flex;gap:14px;align-items:flex-start;">'
      ...
      + '<div style="flex:1;min-width:0;">'
        ...
        + '</div>'
        + '<div style="font-family:var(--serif);font-size:20px;color:var(--ink);font-weight:500;line-height:1.25;margin-bottom:8px;">' + tipo + '</div>'
        + '<div style="font-family:var(--serif);font-size:15px;color:var(--ink-3);font-style:italic;line-height:1.5;">'
          + 'Eh eh, t\'abbiamo beccato! Non proprio la zona Champagne, questa...'
        + '</div>'
      + '</div>'
    + '</div>'
    // ── Card scherzosa ──
